...
Use o recurso [Private vulnerability reporting](https://github.com/ElberBrgs/finder-c/security/advisories/new) do GitHub para relatar de forma privada. Você receberá uma resposta em até 7 dias.

## Escopo

O Finder-C é uma extensão de navegador que roda inteiramente no cliente. Pontos relevantes de segurança:
